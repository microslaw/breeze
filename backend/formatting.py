...
display_format_map: dict[type, Callable[[object], object]] = {}
input_format_map: dict[type,Callable[[object], object]] = {}

# TODO implement formatting exception


def add_display_format(type: type, format_function: Callable[[object], object]):
